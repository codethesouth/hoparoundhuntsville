...
!(function(a, b) {
    ...
    (c = ga.support = {}),
        ...
        return g !== n && g.nodeType === 9 && g.documentElement
          ? ((n = g),
            ...
            (c.getElementsByTagName = ja(
              a => a.appendChild(g.createComment("")),
              !a.getElementsByTagName("*").length
            )),
            (c.getElementsByClassName = $.test(g.getElementsByClassName)),
            (c.getById = ja(
              a => (o.appendChild(a).id = u),
      ...
      (d = ga.selectors = {
        ...
        pseudos: {
          ...
          lang: ia(
            a => W.test(a || "") || ga.error(`unsupported lang: ${a}`),
  ...
  const v = /^.[^:#\[\.,]*$/;
  function w(a, b, c) {
    if (m.isFunction(b)) return m.grep(a, (a, d) => !!b.call(a, d, a) !== c);
    if (b.nodeType) return m.grep(a, a => (a === b) !== c);
    if (typeof b === "string") {
    ...
    return (
      ...
      b.length === 1 && d.nodeType === 1
        ? m.find.matchesSelector(d, a)
          ? [d]
          : []
        : m.find.matches(a, m.grep(b, a => a.nodeType === 1))
    );
  }),
    m.fn.extend({
      find(a) {
  ...
  (m.offset = {
    ...
    typeof define === "function" && define.amd && define("jquery", [], () => m);
  const ec = a.jQuery;
  const fc = a.$;
  return (
